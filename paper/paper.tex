...
\item A normative fixed-point and tick-level semantics (\texttt{nema.tick.v0.1}) with Q8.8 voltage state, tanh-LUT activation, per-tick Q12.8 chemical/gap accumulation, delayed snapshot reads via \texttt{delayTicks}, Euler update, exact rounding/saturation, and digest-visible voltage state.
